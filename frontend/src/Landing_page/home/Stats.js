    ...
    return ( 
        <div className="container p-5">
            ...
            money.</p>
                ...
                <div className="col-6 p-5 "><img src="media/images/ecosystem.png" alt="ecosystem image" style={{width:"90%"}}></img>
                <div  className="text-center">
                    ...
                    <a className="mx-5" href="" style={{textDecoration:"none"}}>Try Kite demo <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    </div>
                    </div>
            </div>
        </div>
